 ...
 *  lang-multi -  whether to allow multi-select
 */
"use strict";
HUMMEDIA_DIRECTIVES.
    directive('selectLanguage', ['language', function(language) {
        ...
        var linkFn = function(scope, iElement, iAttrs, controller) {
            ...
            if(!iAttrs.hasOwnProperty('langMulti')) {
                iElement.removeAttr('multiple');
            }
