define([ "dialog/dialog", "util/lang", "text!layouts/header.html", "ui/user-data", "ui/widget/textbox", "ui/widget/tooltip" ],
  function( Dialog, Lang, HEADER_TEMPLATE, UserData, TextBoxWrapper, ToolTip ) {
